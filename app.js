Uncaught SyntaxError: Unexpected token '}' (at app.js:1582:5)
  /* =======================
     Toast
  ======================= */
  const Toast = (() => {
  ...
  try {
    ...
    // iOS WebKitはObjectURLが不安定なことがあるので dataURL にする
  ...
  try {
    ...
    // ✅ iPhone安定：プレビューは dataURL
    const dataUrl = await blobToDataURL(blob);

    // url は保持しない（ObjectURLを使ってないのでrevoke不要）
